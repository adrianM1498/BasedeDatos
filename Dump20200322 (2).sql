...
-- Dump completed on 2020-03-22 12:48:20
-- MySQL dump 10.13  Distrib 8.0.19, for Win64 (x86_64)
--
...
CREATE TABLE `ingredients` (
  ...
  CONSTRAINT `ingredients_chk_1` CHECK ((`foodgroup` in (_utf8mb4'Milk',_utf8mb4'Meat',_utf8mb4'Bread',_utf8mb4'Fruit',_utf8mb4'Vegetable'))),
  CONSTRAINT `ingredients_chk_2` CHECK (((`unitprice` * `inventory`) <= 4000))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `orders` VALUES (1,1,'#2STR','CKSDS',3.68,'2014-04-26 06:02:04'),(1,2,'#2STR','CHKSD',2.85,'2014-04-26 06:02:19'),(1,3,'#2STR','SODA',0.99,'2014-04-26 06:02:34'),(1,4,'#2STR','GDNSD',0.99,'2014-04-26 06:02:49'),(2,1,'#2STR','CHKSD',2.85,'2014-04-26 06:04:04'),(2,2,'#2STR','SODA',0.99,'2014-04-26 06:04:19'),(3,1,'#2STR','CHKSD',2.85,'2014-04-26 06:05:34'),(3,2,'#2STR','FRPLT',3.99,'2014-04-26 06:05:49'),(3,3,'#2STR','GDNSD',0.99,'2014-04-26 06:06:04'),(1,1,'CASTR','CHKSD',2.85,'2014-04-26 06:22:04'),(1,2,'CASTR','GDNSD',0.99,'2014-04-26 06:22:19'),(2,1,'CASTR','SODA',0.99,'2014-04-26 06:23:34'),(2,2,'CASTR','FRTSD',3.45,'2014-04-26 06:23:49'),(2,3,'CASTR','SODA',0.99,'2014-04-26 06:24:04'),(2,4,'CASTR','VGNET',4.38,'2014-04-26 06:24:19'),(3,1,'CASTR','VGNET',4.38,'2014-04-26 06:25:34'),(3,2,'CASTR','FRPLT',3.99,'2014-04-26 06:25:49'),(3,3,'CASTR','FRTSD',3.45,'2014-04-26 06:26:04'),(3,4,'CASTR','WATER',0.00,'2014-04-26 06:26:19'),(3,5,'CASTR','CHKSD',2.85,'2014-04-26 06:26:34'),(1,1,'FIRST','FRTSD',3.45,'2014-04-26 05:46:04'),(1,2,'FIRST','WATER',0.00,'2014-04-26 05:46:19'),(1,3,'FIRST','WATER',0.00,'2014-04-26 05:46:34'),(2,1,'FIRST','CHKSD',2.85,'2014-04-26 05:47:49'),(3,1,'FIRST','SODA',0.99,'2014-04-26 05:49:04'),(3,2,'FIRST','FRPLT',3.99,'2014-04-26 05:49:19'),(3,3,'FIRST','VGNET',4.38,'2014-04-26 05:49:34'),(1,1,'NDSTR','WATER',0.00,'2014-04-26 06:01:04'),(1,2,'NDSTR','FRPLT',3.99,'2014-04-26 06:01:19'),(2,1,'NDSTR','GDNSD',0.99,'2014-04-26 06:15:34'),(3,1,'NDSTR','VGNET',4.38,'2014-04-26 06:16:49'),(3,2,'NDSTR','FRPLT',3.99,'2014-04-26 06:17:04'),(3,3,'NDSTR','FRTSD',3.45,'2014-04-26 06:17:19'),(3,4,'NDSTR','SODA',0.99,'2014-04-26 06:17:34');
...
INSERT INTO `consulta` VALUES (1,1,'2020-03-21 00:00:00'),(2,2,'2020-03-29 00:00:00'),(3,3,'2020-04-01 00:00:00'),(4,4,'2020-04-05 00:00:00'),(5,5,'2020-05-10 00:00:00');
...
INSERT INTO `consultorio` VALUES (1,1,101),(2,2,111),(3,3,121),(4,4,131),(5,5,141);
...
INSERT INTO `doctor` VALUES (1,344566,1,1),(2,2365422,2,2),(3,3654299,3,3),(4,4518292,4,4),(5,6789392,5,5);
...
INSERT INTO `especialidad` VALUES (1,'Pediatria'),(2,'Odontologia'),(3,'Oncologia'),(4,'Nutricion'),(5,'Neurologia');
...
INSERT INTO `paciente` VALUES (1,7898988,'2020-02-01 00:00:00'),(2,734567,'2020-02-07 00:00:00'),(3,8965282,'2020-02-08 00:00:00'),(4,2578952,'2020-03-01 00:00:00'),(5,4562217,'2020-03-05 00:00:00');
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2020-02-10 13:08:57',NULL),('diagnostics.include_raw','OFF','2020-02-10 13:08:57',NULL),('ps_thread_trx_info.max_length','65535','2020-02-10 13:08:57',NULL),('statement_performance_analyzer.limit','100','2020-02-10 13:08:57',NULL),('statement_performance_analyzer.view',NULL,'2020-02-10 13:08:57',NULL),('statement_truncate_len','64','2020-02-10 13:08:57',NULL);
...
-- Dump completed on 2020-03-22 12:48:23
-- MySQL dump 10.13  Distrib 8.0.19, for Win64 (x86_64)
--
...
INSERT INTO `venta` VALUES (1,'ISIL','2020-01-19',5,'LIB00003',2,45.00,0.00,75.63,14.37,90.00),(2,'UNI','2020-01-20',1,'REV00002',4,6.00,0.00,20.17,3.83,24.00),(3,'Pedro','2020-01-21',3,'LIB00005',6,25.00,0.75,122.27,23.23,145.50),(4,'Pablo','2020-01-21',2,'SEP00002',1,20.00,0.00,16.81,3.19,20.00),(5,'Vilma','2020-01-22',1,'LIB00003',3,45.00,0.00,113.45,21.55,135.00),(6,'Betty','2020-01-22',5,'REV00002',7,6.00,0.18,34.24,6.50,40.74),(7,'Mercy','2020-01-23',6,'LIB00010',3,75.00,0.00,189.08,35.92,225.00),(8,'Cesar','2020-01-24',3,'SEP00002',5,20.00,0.60,81.51,15.49,97.00),(9,'Delia','2020-01-25',6,'LIB00006',8,35.00,1.05,228.24,43.36,271.60),(10,'Nora','2020-01-26',5,'SEP00008',2,10.00,0.00,16.81,3.19,20.00),(11,'Marcelo','2020-01-27',2,'SEP00007',5,8.00,0.24,32.61,6.19,38.80),(12,'Edgar','2020-01-28',2,'LIB00006',3,35.00,0.00,88.24,16.76,105.00),(13,'IPAE','2020-01-29',3,'LIB00003',2,45.00,0.00,75.63,14.37,90.00),(14,'ISL','2020-01-30',6,'REV00002',4,6.00,0.00,20.17,3.83,24.00),(15,'UNI','2020-02-01',1,'LIB00005',6,25.00,0.75,122.27,23.23,145.50),(16,'Carmen','2020-02-01',3,'SEP00005',1,20.00,0.00,16.81,3.19,20.00),(17,'Delia','2020-02-01',5,'LIB00003',3,45.00,0.00,113.45,21.55,135.00),(18,'Ricardo','2020-02-08',1,'REV00002',7,6.00,0.18,34.24,6.50,40.74),(19,'Claudia','2020-02-11',4,'LIB00005',3,25.00,0.00,63.03,11.97,75.00),(20,'Roberto','2020-02-11',6,'SEP00006',5,20.00,0.60,81.51,15.49,97.00),(21,'Nora','2020-02-16',2,'LIB00006',8,35.00,1.05,228.24,43.36,271.60),(22,'Elena','2020-02-16',1,'SEP00004',2,20.00,0.00,33.61,6.39,40.00),(23,'Cynthia','2020-02-19',4,'SEP00007',5,8.00,0.24,32.61,6.19,38.80),(24,'Alejandra','2020-02-19',3,'LIB00007',3,35.00,0.00,88.24,16.76,105.00);
